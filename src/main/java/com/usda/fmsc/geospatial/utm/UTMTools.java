...
public class UTMTools {
    ...
    public static UTMCoords convertLatLonToUTM(Position position) {
        return convertLatLonSignedDecToUTM(position.getLatitude(), position.getLongitude(),
                null);
    }
    ...
    public static UTMCoords convertLatLonSignedDecToUTM(double latitude, double longitude, Integer targetUTM) {
        ...
        M = a * ((1 - eccSquared / 4 - 3 * eccSquared * eccSquared / 64
                - 5 * eccSquared * eccSquared * eccSquared / 256) * latitudeRad
                - (3 * eccSquared / 8 + 3 * eccSquared * eccSquared / 32
                        + 45 * eccSquared * eccSquared * eccSquared / 1024) * Math.sin(2 * latitudeRad)
        ...
        double UTMNorthing = (k0
                * (M + N * Math.tan(latitudeRad) * (A * A / 2 + (5 - T + 9 * C + 4 * C * C) * A * A * A * A / 24
